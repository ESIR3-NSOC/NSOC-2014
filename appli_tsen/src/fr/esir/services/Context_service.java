                                                ...
                                                for (Sensor s : sensors) {
                                                    switch (s.getSensorType()) {
                                                        case SensorType.OUTDOOR_BRIGHTNESS:
                                                            sd.getEnvironmentData(CURRENT_TIMESTAMP).setOutdoorLum(Double.parseDouble(s.getValue()));
                                                        case SensorType.OUTDOOR_HUMIDITY:
                                                            sd.getEnvironmentData(CURRENT_TIMESTAMP).setOutdoorHum(Double.parseDouble(s.getValue()));
                                                        case SensorType.OUTDOOR_TEMPERATURE:
                                                            sd.getEnvironmentData(CURRENT_TIMESTAMP).setOutdoorTemp(Double.parseDouble(s.getValue()));
                                                        case SensorType.INDOOR_TEMPERATURE:
                                                            sd.getEnvironmentData(CURRENT_TIMESTAMP).setIndoorTemp(Double.parseDouble(s.getValue()));
